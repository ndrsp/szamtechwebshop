...
public class ShoppingItemAdapterForShoppingCart extends RecyclerView.Adapter<ShoppingItemAdapterForShoppingCart.VH> implements Filterable {
    ...
    ShoppingItemAdapterForShoppingCart(Context context, ArrayList<ShoppingItem> itemsData){
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) { //ViewHolder
        return new VH(LayoutInflater.from(mContext).inflate(R.layout.list_products_shopping_cart,parent,false));
    }
    ...
    class VH extends RecyclerView.ViewHolder{
        ...
        public void bindTo(ShoppingItem currentItem) {
            ...
            itemView.findViewById(R.id.delete).setOnClickListener(view -> ((ShoppingCart)mContext).deleteItem(currentItem));
